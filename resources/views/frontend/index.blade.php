...
@section('content')
                ...
                <div class="container">
                    <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                        <div class="col-md-12 text-center">
                            ...
                            <h2 class="subheading mb-4">Chúng tôi cung cấp các loại trà uy tín,chất lượng nhất</h2>
                        </div>
    ...
    <section class="ftco-section img w-100" style="background-image: url(frontend/images/bg_3.jpg);">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-md-6 heading-section">
                    ...
                    <p>Luôn luôn đem tới cho các bạn sản phẩm có chất lượng tốt nhất</p>
                    <h3><a href="#">Bàn trà,khay trà , ấm chén</a></h3>
                    <span class="price">Giá hấp dẫn chỉ còn <a href="#"> 50.000 đ</a></span>
                </div>
            </div>
        </div>
    </section>
